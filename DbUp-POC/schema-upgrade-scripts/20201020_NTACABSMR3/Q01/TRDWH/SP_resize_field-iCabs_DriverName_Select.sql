...
/****** Object:  StoredProcedure [dbo].[iCabs_DriverName_Select]    Script Date: 5/14/2020 2:56:19 PM ******/
SET ANSI_NULLS ON
GO
...
=============================================
*/
ALTER PROCEDURE [dbo].[iCabs_DriverName_Select]
...
insert into temp_driver (Licence, Full_Name, Date_Of_Birth, Address_1, Address_2, Town, County,LicenseStatus)
(select licnum, fname + ' ' + sname, dob,add1,add2,add3,add4,LicenseStatus from DWH_DriverMaster)
