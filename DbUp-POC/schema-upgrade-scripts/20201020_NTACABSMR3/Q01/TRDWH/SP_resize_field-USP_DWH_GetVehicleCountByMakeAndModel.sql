...
/****** Object:  StoredProcedure [dbo].[USP_DWH_GetVehicleCountByMakeAndModel]    Script Date: 5/14/2020 4:11:28 PM ******/
SET ANSI_NULLS ON
GO
...
=============================================
*/
ALTER PROCEDURE [dbo].[USP_DWH_GetVehicleCountByMakeAndModel]
				@Status NVarChar(20)
