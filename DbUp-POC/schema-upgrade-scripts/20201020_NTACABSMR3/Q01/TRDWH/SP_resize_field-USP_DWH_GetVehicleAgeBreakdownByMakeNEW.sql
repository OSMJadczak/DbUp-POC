...
/****** Object:  StoredProcedure [dbo].[USP_DWH_GetVehicleAgeBreakdownByMakeNEW]    Script Date: 5/14/2020 4:08:07 PM ******/
SET ANSI_NULLS ON
GO
...
=============================================
*/
ALTER PROCEDURE [dbo].[USP_DWH_GetVehicleAgeBreakdownByMakeNEW]
				@Status NVarChar(20)
...
*/
Select 
	E.Reg_Nbr, E.Plate_Nbr, E.Licence_Nbr, E.Old_Plate_Nbr, E.First_Nm, E.Last_Nm, Title_Cd, Addr_1, Addr_2
