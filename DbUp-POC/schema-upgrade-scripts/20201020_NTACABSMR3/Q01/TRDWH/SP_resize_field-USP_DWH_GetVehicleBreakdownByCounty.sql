...
/****** Object:  StoredProcedure [dbo].[USP_DWH_GetVehicleBreakdownByCounty]    Script Date: 5/14/2020 4:08:57 PM ******/
SET ANSI_NULLS ON
GO
...
=============================================
*/
ALTER PROCEDURE [dbo].[USP_DWH_GetVehicleBreakdownByCounty]
				@Status NVarChar(20)
