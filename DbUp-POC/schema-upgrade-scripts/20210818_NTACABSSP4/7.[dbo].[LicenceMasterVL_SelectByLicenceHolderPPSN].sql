USE [cabs_production]
GO
/****** Object:  StoredProcedure [dbo].[LicenceMasterVL_SelectByLicenceHolderPPSN]    Script Date: 8/18/2021 12:19:07 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[LicenceMasterVL_SelectByLicenceHolderPPSN]
(
@LicenceHolderPPSN varchar(20)
)
...
SELECT L.PlateNumber AS L_PlateNumber
     ...
     , L_TC.ContactNumberFax AS L_TC_ContactNumberFax
     ...
     , V_TC.ContactNumberFax AS V_TC_ContactNumberFax
