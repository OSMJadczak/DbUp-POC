USE [cabs_production]
GO
/****** Object:  StoredProcedure [dbo].[LicenceMasterVL_SelectByLicenceHolderId]    Script Date: 8/18/2021 12:19:05 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[LicenceMasterVL_SelectByLicenceHolderId]
(
@LicenceHolderId int
)
...
WHERE
    L.LicenceHolderId = @LicenceHolderId
