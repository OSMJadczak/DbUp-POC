...
-- =============================================
ALTER PROCEDURE [dbo].[VehicleMaster_SelectByRegistrationNumber]
...
V.RegistrationNumber, V.VehicleAge, 
...
V.RegistrationDate, LastDocumentationCheckDate,
...
V.TypeApprovalCategory, V.PermissibleMassGvw, 
V.MileageReading, V.ExcessWindowTint, V.RoofSignSticker, V.MeterSealed, V.DataCheckedDate,
V.CreatedBy, V.CreatedDate, V.ModifiedBy, V.ModifiedDate,
...
LM.FinalOperationDate as LM_FinalOperationDate, LM.LicenceStateId as LM_LicenceStateId, LM.LicenceStateMasterId as LM_LicenceStateMasterId,

V.NedcCo2Emission as V_NedcCo2Emission, V.WltpCo2Emission as V_WltpCo2Emission,
V.MPAExtensionRule as V_MPAExtensionRule
...
LEFT OUTER JOIN dbo.LicenceMasterVL  LM on  LM.RegistrationNumber = V.RegistrationNumber 
