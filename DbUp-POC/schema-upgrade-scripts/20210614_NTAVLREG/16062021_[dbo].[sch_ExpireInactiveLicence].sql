...
/****** Object:  StoredProcedure [dbo].[sch_ExpireInactiveLicence]    Script Date: 6/16/2021 4:34:59 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	AND ( 
		(LicenceExpiryDate>=CONVERT(datetime,'1-1-2013') and DATEADD(year, @LicenceRenewalPeriod,LicenceExpiryDate) < @modifiedDate) --rule 1
		OR
