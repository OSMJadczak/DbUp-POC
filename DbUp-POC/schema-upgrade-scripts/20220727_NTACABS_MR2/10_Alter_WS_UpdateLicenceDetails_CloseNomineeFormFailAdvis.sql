...
/****** Object:  StoredProcedure [dbo].[WS_UpdateLicenceDetails]    Script Date: 02.09.2022 11:05:30 ******/
SET ANSI_NULLS ON
GO
...
--*********************************************** Inactive Suspended Inspection **************************************************
	   ...
	   --*********************************************** handle nominee **************************************************
	   IF (EXISTS (Select * from dbo.VehicleInspections vi join dbo.Booking b ON vi.BookingId=b.BookingId Where vi.BookingId=@BookingId AND vi.TestResultId in (1,4)
