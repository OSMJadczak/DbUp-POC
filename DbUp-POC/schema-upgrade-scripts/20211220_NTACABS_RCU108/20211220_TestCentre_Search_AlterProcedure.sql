...
/****** Object:  StoredProcedure [dbo].[TestCentre_Search]    Script Date: 2021-12-20 13:58:50 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[TestCentre_Search]
(
...
BEGIN
	...
	WHERE 
	T.TestCentreName LIKE '%' + @SearchString + '%'
	OR C.CountyName LIKE '%' + @SearchString + '%'
