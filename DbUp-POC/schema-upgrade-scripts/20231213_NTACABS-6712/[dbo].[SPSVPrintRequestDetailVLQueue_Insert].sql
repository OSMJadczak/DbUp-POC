USE [cabs_production]
GO
/****** Object:  StoredProcedure [dbo].[SPSVPrintRequestDetailVLQueue_Insert]    Script Date: 13/12/2023 12:28:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[SPSVPrintRequestDetailVLQueue_Insert]
(
	@PrintCompanyId int,
...
BEGIN
	...
	(
		SELECT PrintRequestMasterId FROM dbo.PrintRequestMasterVL cabs_production WHERE SkBookingID is null and LetterRequestTypeAuditId IN 
        (
            ...
            where lraudit.LetterCode like 'SPSV%' and lrtype.IsActive = 1
        )
	)
	AND DespatchMethodID = 3
