...
/****** Object:  StoredProcedure [dbo].[WS_UpdateLicenceDetails]    Script Date: 1/14/2020 12:31:30 PM ******/
SET ANSI_NULLS ON
GO
...
--*********************************************** Inactive Suspended Inspection **************************************************
        ...
        SELECT l.PlateNumber,
               ...
               l.HistoryChangeId,
               l.TestCenterId,
               l.RemainingTransfers,
               l.TransferDate,
               l.OldPlateNumber,
               l.OldLicenceAuthority,
               lh.Ccsn,
               lh.Ppsn,
               lh.CompanyNumber,
               lh.TitleId,
               ...
               lh.PhoneNo2,
               lh.Email,
               lh.TaxClearanceNumber,
               lh.TaxClearanceExpiryDate,
               lh.TaxClearanceStatus,
               lh.TaxClearanceVisual,
               lh.TaxClearanceName,
               @user,
               @now,
               @user,
        ...
        FROM   dbo.LicenceMasterVL AS l
               INNER JOIN
               dbo.LicenceHolderMaster AS lh
               ON l.LicenceHolderId = lh.LicenceHolderId
