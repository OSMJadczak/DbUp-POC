...
/****** Object:  StoredProcedure [dbo].[USP_DWH_PrintRequestVL_Insert]    Script Date: 14/12/2023 14:59:13 ******/
SET ANSI_NULLS ON
GO
...
DECLARE @LicenceRenewalPeriod int = (
    ...
    BEGIN
        Begin Transaction CreatePrintRequest
			...
			if (@LetterRequestTypeId is not null and @LetterRequestTypeId in (2,3,5,15,8,25,61,62,80,81,82,83,84,85))		                                 
