...
ConvertTo-HTML -head $a -PostContent $frag1,$frag7,$frag8,$frag9,$frag10,$frag14,$frag15,$frag11,$frag12,$frag13 -PreContent "<h1>SQL Server Health Check Report</h1>" | Out-File $OutputFile_new
