# Script will generate Disk Space Report for CAB Servers

$ErrorActionPreference = "SilentlyContinue";
$scriptpath = $MyInvocation.MyCommand.Definition 
$dir = Split-Path $scriptpath 
$dir = "C:\SpaceAnalysis\DiskSpaceAlertAndReport\DiskSpaceReport"
#Variables to configure
$percentWarning = 25;
$percentCritcal = 15;
$smtpServer = "NTA-CABUT2-APP2" 
$ReportSender = "no_replyuat2@nationaltransport.ie"  
$users = "anosal@openskydata.com", "rpodgorski@openskydata.com", "kbyrne@openskydata.com"; 

$MailSubject = "DiskSpace Report for [UAT2] $titledate"
