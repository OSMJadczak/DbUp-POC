USE [cabs_production]
GO
/****** Object:  StoredProcedure [dbo].[USP_DWH_PrintRequestVL_Insert]    Script Date: 5/24/2023 1:32:08 PM ******/
SET ANSI_NULLS ON
GO
...
DECLARE @LicenceRenewalPeriod int = (
    ...
    BEGIN
        Begin Transaction CreatePrintRequest
			...
			-- 92   FPN Letter
			-- 93   DTO Reminder Letter

        
			if (@LetterRequestTypeId is not null and @LetterRequestTypeId in (2,3,5,15,8,25,61,62,80,81,82,83,84,85,92,93))		                                 
