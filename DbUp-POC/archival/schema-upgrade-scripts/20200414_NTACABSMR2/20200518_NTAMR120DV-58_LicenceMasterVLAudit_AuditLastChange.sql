...
/****** Object:  StoredProcedure [dbo].[LicenceMasterVLAudit_AuditLastChange]    Script Date: 5/18/2020 9:51:40 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[LicenceMasterVLAudit_AuditLastChange] @LicenceNumber varchar(20), @ModifiedDate datetime, @ModifiedBy nvarchar(20) = NULL
AS
BEGIN
