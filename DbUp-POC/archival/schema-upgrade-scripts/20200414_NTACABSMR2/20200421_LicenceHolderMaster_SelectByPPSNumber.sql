...
/****** Object:  StoredProcedure [dbo].[LicenceHolderMaster_SelectByPPSNumber]    Script Date: 4/21/2020 1:28:44 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<Stored procedure to search for a LicenceHolder by PPS Number>
-- =============================================
ALTER PROCEDURE [dbo].[LicenceHolderMaster_SelectByPPSNumber]
