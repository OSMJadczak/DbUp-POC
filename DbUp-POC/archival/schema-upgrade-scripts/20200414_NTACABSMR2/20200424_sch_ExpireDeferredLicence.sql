...
/****** Object:  StoredProcedure [dbo].[sch_ExpireDeferredLicence]    Script Date: 4/24/2020 2:29:12 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	AND L.LicenceNumber in (Select top 1 LA.LicenceNumber from  LicenceMasterVLAudit LA Where LA.HistoryChangeID=11 
	AND DATEDIFF(DAY, LA.AuditDate, GETDATE()) > 30 AND DATEDIFF(DAY, LA.AuditDate, GETDATE()) < 32  AND LA.LicenceStateId=9 and LA.LicenceStateMasterId=5
