...
/****** Object:  StoredProcedure [dbo].[USP_DWH_GetVehicleCountByMakeAndModelNEW]    Script Date: 5/14/2020 4:11:50 PM ******/
SET ANSI_NULLS ON
GO
...
Exec USP_DWH_GetVehicleCountByMakeAndModel 'ACTIVE', '31/Dec/2008'

=============================================
*/
ALTER PROCEDURE [dbo].[USP_DWH_GetVehicleCountByMakeAndModelNEW]
				@Status NVarChar(20)
...
*/
Select 
	E.Reg_Nbr, E.Plate_Nbr, Licence_Nbr, Old_Plate_Nbr, First_Nm, Last_Nm, Title_Cd, Addr_1, Addr_2
...
Select Top 10 Rank() Over (Order By Count(*) Desc) As VehicleRank, Make + ' ' + Model As VehicleModel, 'All' As SPSVCategory, Count(*) As NumberOfVehicles, (Select Count(*) From #Vehicles) As FleetTotal From #Vehicles Group By Make + ' ' + Model
Union All
Select Top 10 Rank() Over (Order By Count(*) Desc) As VehicleRank, Make + ' ' + Model As VehicleModel, SPSVCategory, Count(*) As NumberOfVehicles, (Select Count(*) From #Vehicles Where SPSVCategory = 'Taxi') As FleetTotal From #Vehicles Where SPSVCategory = 'Taxi' Group By Make + ' ' + Model, SPSVCategory
Union All
Select Top 10 Rank() Over (Order By Count(*) Desc) As VehicleRank, Make + ' ' + Model As VehicleModel, SPSVCategory, Count(*) As NumberOfVehicles, (Select Count(*) From #Vehicles Where SPSVCategory = 'Hackney') From #Vehicles Where SPSVCategory = 'Hackney' Group By Make + ' ' + Model, SPSVCategory
Union All
Select Top 10 Rank() Over (Order By Count(*) Desc) As VehicleRank, Make + ' ' + Model As VehicleModel, SPSVCategory, Count(*) As NumberOfVehicles, (Select Count(*) From #Vehicles Where SPSVCategory = 'Wheelchair Accessible Taxi') From #Vehicles Where SPSVCategory = 'Wheelchair Accessible Taxi' Group By Make + ' ' + Model, SPSVCategory
Union All
Select Top 10 Rank() Over (Order By Count(*) Desc) As VehicleRank, Make + ' ' + Model As VehicleModel, SPSVCategory, Count(*) As NumberOfVehicles, (Select Count(*) From #Vehicles Where SPSVCategory = 'Limousine') From #Vehicles Where SPSVCategory = 'Limousine' Group By Make + ' ' + Model, SPSVCategory
