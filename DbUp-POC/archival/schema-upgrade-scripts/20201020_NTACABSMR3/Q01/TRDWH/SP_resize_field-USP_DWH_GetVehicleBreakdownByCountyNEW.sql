...
/****** Object:  StoredProcedure [dbo].[USP_DWH_GetVehicleBreakdownByCountyNEW]    Script Date: 5/14/2020 4:09:25 PM ******/
SET ANSI_NULLS ON
GO
...
Exec USP_DWH_GetVehicleBreakdownByCounty 'ACTIVE', '31/Dec/2008'

=============================================
*/
ALTER PROCEDURE [dbo].[USP_DWH_GetVehicleBreakdownByCountyNEW]
				@Status NVarChar(20)
...
Select dbo.Fn_DWH_GetAlphaNumeric(Replace(Replace(County, '.', ''), 'CO ', '')) As County
	, SPSVCategory, Count(*) As NumberOfVehicles From #Vehicles Group By County, SPSVCategory Order By County
