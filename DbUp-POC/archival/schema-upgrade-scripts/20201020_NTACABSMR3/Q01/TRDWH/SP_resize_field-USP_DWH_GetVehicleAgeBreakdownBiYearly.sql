...
/****** Object:  StoredProcedure [dbo].[USP_DWH_GetVehicleAgeBreakdownBiYearly]    Script Date: 5/14/2020 4:05:20 PM ******/
SET ANSI_NULLS ON
GO
...
=============================================
*/
ALTER PROCEDURE [dbo].[USP_DWH_GetVehicleAgeBreakdownBiYearly]
				@Status NVarChar(20)
...
Union All
Select 10 As RankOrder, '10+ years of age' As Age, SPSVCategory, Count(*) As NumberOfVehicles From #Vehicles Where VehicleAge >= 10 Group By SPSVCategory
