...
/****** Object:  StoredProcedure [dbo].[TEMP_SP]    Script Date: 5/14/2020 3:10:10 PM ******/
SET ANSI_NULLS ON
GO
...
Select 
	...
	, MobileNumber, Pps_Number, Company_Number, Refused_Mobile_No, E.VIN, E.DateFirstReg, E.EngineCC
	...
	, datediff(year, isnull(dbo.DWH_VehicleMaster.DateFirstReg, dbo.DWH_VehicleMaster.DateOfRegistrationInIreland),@ExtractDate)
