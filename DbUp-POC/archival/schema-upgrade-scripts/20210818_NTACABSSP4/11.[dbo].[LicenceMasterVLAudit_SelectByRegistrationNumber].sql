USE [cabs_production]
GO
/****** Object:  StoredProcedure [dbo].[LicenceMasterVLAudit_SelectByRegistrationNumber]    Script Date: 8/18/2021 12:41:34 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[LicenceMasterVLAudit_SelectByRegistrationNumber]
...
L.LicenceHolderId, L.RegistrationNumber, L.AuditDate,L.LAHArea,L.LAHDriverLicenceNumber,L.MotorTaxRebateStatusId, L.MotorTaxRebateDate,
...
L.LicenceHolderId, L.Ccsn, L.Ppsn, 
...
, DispatchOperatorId as AffiliatedDO
, l.EmailAddressForBooking as WavEmail
, l.NumberForBookings
, l.Website
, l.AreaOfOpperations
, SCS.Description as ScrappageGrantStatusDescription
,L.*
...
LEFT OUTER JOIN dbo.ScrappageGrantStatuses SCS on L.ScrappageGrantStatusId = SCS.Id	
LEFT OUTER JOIN dbo.MTRebateStatus MTS ON L.MotorTaxRebateStatusId = MTS.MTRebateStatusId
