USE [cabs_production]
GO
/****** Object:  StoredProcedure [dbo].[LicenceMasterVL_SelectByRegistrationNumber]    Script Date: 8/18/2021 12:26:04 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[LicenceMasterVL_SelectByRegistrationNumber]
(
...
WHERE
    L.RegistrationNumber = @RegistrationNumber
