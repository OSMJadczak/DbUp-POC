...
/****** Object:  StoredProcedure [dbo].[VehicleMaster_SelectByLicenceMasterVLAudit]    Script Date: 2021-12-22 10:29:04 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[VehicleMaster_SelectByLicenceMasterVLAudit]
(
...
(
	SELECT RegistrationNumber FROM LicenceMasterVLAudit
